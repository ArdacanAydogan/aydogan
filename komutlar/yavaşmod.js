...
if (limit > 10) {
  ...
  .setDescription("Yazma Süresi maksimum **10** saniye olabilir!")
  .setColor("RANDOM")
  msg.channel.send({embed: x});
    return
}
    var e = new Discord.RichEmbed()
    .setDescription(`Yazma Süresi başarıyla **${limit}** saniye olarak ayarlanmıştır!  <a:mavitik2:823373976319033364> `)
    .setColor("RANDOM")
